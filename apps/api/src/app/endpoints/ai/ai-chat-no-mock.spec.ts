/**
 * No mock tests — real LangGraph and real OpenAI API.
...
describe('No mock tests', () => {
  ...
  itWithKey(
    '"How much money do I have?" traverses router → data agent → compliance (real LangGraph, real OpenAI)',
    async () => {
